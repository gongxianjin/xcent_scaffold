...
var BaseMenus = []model.SysBaseMenu{
	{BaseModel: model.BaseModel{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId:0, Path: "/account/center", Name: "dashboard", Hidden: false, Component: "RouteView", Sort: 1, Meta: model.Meta{Title: "仪表盘", Icon: "setting",Show: true}},
	{BaseModel: model.BaseModel{ID: 2, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId:1, Path: "/account/center", Name: "account", Component: "RouteView", Sort: 7, Meta: model.Meta{Title: "关于我们", Icon: "info",Show: true}},
	...
	{BaseModel: model.BaseModel{ID: 26, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: 1, Path: "https://www.baidu.com", Name: "https://www.baidu.com", Hidden: false, Component: "/", Sort: 0, Meta: model.Meta{Title: "官方网站", Icon: "s-home"}},
